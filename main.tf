...
locals {
  ...
  use_internal_queue  = var.use_external_bucket || var.use_internal_queue
}
...
locals {
  ...
  bucket_queue_name = local.use_internal_queue ? module.file_storage.0.bucket_queue_name : null
}
