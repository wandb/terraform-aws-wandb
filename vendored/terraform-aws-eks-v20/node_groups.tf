...
module "eks_managed_node_group" {
  ...
  # Forwarding for the v17 -> v20 in-place upgrade compatibility variable
  # added in modules/eks-managed-node-group. Default "-" preserves stock
  # v20 behavior; "" matches v17's no-separator name_prefix pattern.
