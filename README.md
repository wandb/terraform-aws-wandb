...
| <a name="module_app_eks"></a> [app\_eks](#module\_app\_eks) | ./modules/eks-cluster | n/a |
| <a name="module_app_lb"></a> [app\_lb](#module\_app\_lb) | ./modules/application-load-balancer | n/a |
...
| <a name="input_database_engine_version"></a> [database\_engine\_version](#input\_database\_engine\_version) | Version for MySQL Auora | `string` | `"8.0.mysql_aurora.3.04.0"` | no |
...
| <a name="input_kubernetes_instance_types"></a> [kubernetes\_instance\_types](#input\_kubernetes\_instance\_types) | EC2 Instance type for primary node group. | `list(string)` | <pre>[<br>  "is4gen.medium"<br>]</pre> | no |
...
| <a name="output_elasticache_security_group_ids"></a> [elasticache\_security\_group\_ids](#output\_elasticache\_security\_group\_ids) | n/a |
