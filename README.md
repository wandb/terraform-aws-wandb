...
| <a name="kubernetes_instance_types"></a> [kubernetes_instance_types](#kubernetes_instance_types)                            | EC2 Instance type for primary node group.                                                                                     | `list(string)` | `["m4.large"]`                                             |    no    |
