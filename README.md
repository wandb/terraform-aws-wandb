...
| <a name="kubernetes_instance_types"></a> [kubernetes_instance_types](#kubernetes_instance_types)                            | EC2 Instance type for primary node group.                                                                                     | `list(string)` | `["m5.xlarge"]`                                            |    no    |
| <a name="kubernetes_encrypt_ebs_volume"></a> [kubernetes_encrypt_ebs_volume](#kubernetes_encrypt_ebs_volume)                | Enable Encrypted EBS volumes through the use of launch templates.                                                             | `bool`         | `true`                                                     |    no    |
